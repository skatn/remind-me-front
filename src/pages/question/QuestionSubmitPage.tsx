...
const QuestionSubmitPage = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <Suspense>
        <Question subjectId={subjectId} questionId={questionId} />
      </Suspense>
    </div>
  );
};
...
const Question = ({ subjectId, questionId }: QuestionProps) => {
    ...
    <>
      ...
      {modalState.isOpen && (
        <SimpleModal
          ...
          rightBtnTxt="확인"
          onClickLeftBtn={() => {
            navigate(`/subjects/${subjectId}/questions/${questionId}/explain`, {
